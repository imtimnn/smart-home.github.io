...
//auto update ImgDen
database.ref("/bedroom/led01").on("value", function(snapshot1) {
    if (snapshot1.exists()) {
...
database.ref("/bedroom/led02").on("value", function(snapshot2) {
    if (snapshot2.exists()) {
...
database.ref("/bedroom/led03").on("value", function(snapshot3) {
    if (snapshot3.exists()) {
